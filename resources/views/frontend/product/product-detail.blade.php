    ...
    <div class="product-details"><!--product-details-->
        <div class="col-sm-5 image_area" >
            <div class="view-product">
                <img class="img_3" src="{{asset('upload/product/'.Auth::id().'/'.json_decode($product['image'],true)[0])}}" alt="" />
                <a href="{{asset('upload/product/'.Auth::id().'/'.json_decode($product['image'],true)[0])}}" rel="prettyPhoto"><h3>ZOOM</h3></a>
                    ...
                    <div class="carousel-inner">
                        ...
                        ">
                          @foreach(json_decode($product['image'], true) as $key => $image)
                            <img class="img_2" id="{{ $key }}" src="{{ asset('upload/product/'.Auth::id().'/_85'.$image) }}" alt=""/>
                          @endforeach                
                          </div>
                          @endfor
                    </div>
...
<script>
    $(document).ready(function()
    {
      $('img.img_2').click(function()
      {
        ...
        img2 = img2.slice(61,img2.length)
        console.log(img2,'sádf')

        var img3 = $(this).closest('div.image_area').find('img').attr('src');
        img3 = img3.slice(0,58);
        console.log(img3,'ffffff');

        var img = $(this).closest('div.image_area').find('a').attr('href');
        img = img.slice(0,68);
        // console.log(img,'dfsdfsd');
